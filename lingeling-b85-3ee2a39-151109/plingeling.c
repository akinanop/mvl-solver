...
static void setopts (LGL * lgl, int i) {
  ...
  if (i && (locs >= 2 || (locs && (i > 7 || (i & 1))))) {
    ...
    switch (j % 16) {
      ...
      case 2: setopt (i, lgl, "gluekeep", 5); break;
      case 3: setopt (i, lgl, "block", 0), setopt (i, lgl, "cce", 0); break;
      case 4: setopt (i, lgl, "gluekeep", 2); break;
      case 5: setopt (i, lgl, "elmrtc", 1); break;
      case 6: setopt (i, lgl, "phase", 1); break;
      case 7: setopt (i, lgl, "hbrdom", 0); break;
      case 8: setopt (i, lgl, "sweeprtc", 1); break;
      case 9: setopt (i, lgl, "retiremin", 0); break;
      case 10: setopt (i, lgl, "phase", -1); break;
      case 11: setopt (i, lgl, "reduceinit", 5000); break;
      case 12: setopt (i, lgl, "redclsize", 200); break;
      case 13: setopt (i, lgl, "score", 4); break;
      case 14: setopt (i, lgl, "queue", 0); break;
      case 15: setopt (i, lgl, "subl", 0); break;
    }
  }
